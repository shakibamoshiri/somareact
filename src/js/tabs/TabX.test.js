...
describe('TabX Component:', () => {
    ...
    it( "label.dataset.switch should be equal to array index", () => {
        dom.find( ".tab-x-indicator" ).children().forEach( ( label, index ) => {
